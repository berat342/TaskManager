...
class AppConst{
  ...
  static const Color kLight = Color(0xFFFFFFFF);  // Örnek bir ışık renk değeri
  static const Color kRed = Color(0xFFd80000);
  static const Color kBlueLight = Color(0xFF027eb5); // Bu renk, belirtilen hexadecimal renk koduna sahiptir
