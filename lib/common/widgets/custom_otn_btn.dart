...
class Custom0tlnBtn extends StatelessWidget {
  const Custom0tlnBtn({super.key, this.onTap, required this.width, required this.height, this.color2, required this.color, required this.text});
